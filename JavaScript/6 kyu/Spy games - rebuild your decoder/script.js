...
const decrypt = (code) =>
  code
    ...
    .split(" ")
    .map((code) => {
      let num = code.split("").reduce((acc, curr) => acc + +curr, 0);
      if (num === 0 || num === 27) {
        return " ";
      } else {
        return String.fromCharCode((num % 27) + 96);
      }
    })
    .join("");
console.log(decrypt("%v=7265E5G06j~0 HWA42090_ 20!x36TI83I5 *2@ki04d2O7j"));
