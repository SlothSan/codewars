...
const longestVowelSubstringLength = (str) => {
  let maxCount = 0;
  let count = 0;
...
const sortStringsByVowels = (arr) => {
  return arr.sort((a, b) => {
    const lengthA = longestVowelSubstringLength(a);
    const lengthB = longestVowelSubstringLength(b);
