...
const was_package_received_yesterday = (tz_from, tz_to, start, duration) =>
  Math.floor((start + duration + tz_to - tz_from) / 24) < 0;

console.log(was_package_received_yesterday(7, 1, 5, 0)); //true
