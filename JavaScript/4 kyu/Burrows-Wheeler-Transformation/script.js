...
const encode = (s) => {
  ...
  const result = rotations.map((row) => row[row.length - 1]).join("");
  const index = rotations.indexOf(s);
...
console.log(encode("bananas")); //['bnnsaaa', 3]
console.log(decode("bnnsaaa", 3)); //bananas
