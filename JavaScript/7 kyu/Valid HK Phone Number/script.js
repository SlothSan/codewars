...
const isValidHKPhoneNumber = (str) => {
  return /^\d{4} \d{4}$/.test(str);
};

const hasValidHKPhoneNumber = (str) => {
  return /\d{4} \d{4}/.test(str);
};

console.log(
  hasValidHKPhoneNumber("I wonder if 2359 1478 is a valid phone number?")
); //true

console.log(isValidHKPhoneNumber("2345 1234")); //true
