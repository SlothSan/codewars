...
const conferencePicker = (citiesVisited, citiesOffered) => {
    let possibleCities = citiesOffered.filter((city) => !citiesVisited.includes(city));
    return possibleCities.length > 0 ? possibleCities[0] : 'No worthwhile conferences this year!';
}
