...
const kaprekarSplit = (n) => {
  let nSquare = (n * n).toString();
  let length = nSquare.length;

  for (let i = 0; i <= length; i++) {
    let part1 = nSquare.substring(0, i);
    let part2 = nSquare.substring(i);

    let num1 = part1 === "" ? 0 : parseInt(part1, 10);
    let num2 = part2 === "" ? 0 : parseInt(part2, 10);
