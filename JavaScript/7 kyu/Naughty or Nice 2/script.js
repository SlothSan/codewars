...
const naughtyOrNice = (data) => {
  ...
  for (let month in data) {
    let currMonth = data[month];
    for (let day in currMonth) {
      let string = currMonth[day];
      string === "Naughty" ? naughtyDays++ : niceDays++;
    }
  }

  return naughtyDays === niceDays || niceDays > naughtyDays
    ? "Nice!"
    : "Naughty!";
};
