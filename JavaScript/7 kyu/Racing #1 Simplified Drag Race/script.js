...
const dragRace = (len, anna, bob) => {
  let annaTime = anna.reactionTime + len / anna.speed;
  let bobTime = bob.reactionTime + len / bob.speed;
  return annaTime === bobTime
    ? `It's a draw`
    : annaTime < bobTime
    ? "Anna is the winner"
    : "Bob is the winner";
...
const ANNA = new Car(20, 1);
const BOB = new Car(30, 3);

console.log(dragRace(150, ANNA, BOB));
