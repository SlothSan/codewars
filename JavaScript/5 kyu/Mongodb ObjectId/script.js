/*
created. This field is unique and contains some information about the time the element was created, id of the process that created it, and so on. More information can be found in the MongoDB documentation (which you have to read in order to implement this Kata).
...
class Mongo {
  ...
  static getTimestamp(s) {
    if (typeof s === "string") {
      if (s.length !== 24) return false;
      if (/^[0-9a-f]+$/.test(s)) {
        const d = parseInt(s.substring(0, 8), 16);
